...
abstract class $AppStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {bool isDarkMode, bool isLtr, int? index, LanguageData? activeLanguage});
}
...
class _$AppStateImpl extends _AppState {
  ...
  @override
  String toString() {
    return 'AppState(isDarkMode: $isDarkMode, isLtr: $isLtr, index: $index, activeLanguage: $activeLanguage)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, isDarkMode, isLtr, index, activeLanguage);
