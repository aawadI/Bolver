...
class UserData {
  UserData({
    ...
    _passportSecret = passportSecret;
    _email = email;
    _phone = phone;
    _birthday = birthday;
    _gender = gender;
  ...
  UserData.fromJson(dynamic json) {
    ...
    _passportSecret = json['passport_secret'];
    _email = json['email'];
    _phone = json['phone'];
  ...
  UserData copyWith({
    ...
    Wallet? wallet,
      ...
      UserData(
        ...
        passportSecret: passportSecret ?? _passportSecret,
        email: email ?? _email,
        phone: phone ?? _phone,
  ...
  String? get passportSecret => _passportSecret;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['passport_secret'] = _passportSecret;
    map['email'] = _email;
    map['phone'] = _phone;
