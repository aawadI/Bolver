...
class AppColors {
  ...
  static const Color buttonColor = Color.fromRGBO(0,0,0,.62);
  ...
  static const Color brandDescription = Color.fromRGBO(146, 146, 146, 1);
  ...
  static const Color mainCategoryItem = Color(0xFFECEFF3);
