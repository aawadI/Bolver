...
import 'package:g_customer/src/presentation/pages/auth/register/register_modal.dart';
                                  ...
                                  child: AccentLoginButton(
                                    ...
                                    onPressed: state.confirmCode.length > 5
                                        ? () => notifier.confirmCode(
                                            context, enterPhoneState.verifyId,
                                            onSuccess: () => AppHelpers
                                                    .showCustomModalBottomSheet(
                                                  context: context,
                                                  modal: const RegisterModal(),
