...
class _$LoginStateImpl extends _LoginState {
  ...
  @override
  String toString() {
    return 'LoginState(isLoading: $isLoading, isGoogleLoading: $isGoogleLoading, isAppleLoading: $isAppleLoading, isFacebookLoading: $isFacebookLoading, showPassword: $showPassword, isLoginError: $isLoginError, isEmailNotValid: $isEmailNotValid, isPasswordNotValid: $isPasswordNotValid, email: $email, password: $password)';
  }
