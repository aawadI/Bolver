...
class BrandsInShopDetails extends StatelessWidget {
  final Function() onSeeAllPressed;

  const BrandsInShopDetails({Key? key, required this.onSeeAllPressed})
      : super(key: key);
        ...
        children: [
          ...
          Consumer(
            builder: (context, ref, child) {
              ...
              return ref.watch(homeMostSoldProvider).isLoading
