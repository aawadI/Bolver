...
class SingleShopSearchNotifier extends StateNotifier<SingleShopSearchState> {
  final ProductsRepository _productsRepository;
  Timer? _timer;

  SingleShopSearchNotifier(this._productsRepository)
      : super(const SingleShopSearchState());
