...
class SingleShopDiscounts extends StatelessWidget {
  final VoidCallback onSeeAllPressed;

  const SingleShopDiscounts({Key? key, required this.onSeeAllPressed})
      : super(key: key);
        ...
        children: [
          ...
          Consumer(
            builder: (context, ref, child) {
              final state = ref.watch(singleShopDiscountsProvider);
              final event = ref.read(singleShopDiscountsProvider.notifier);
                      ...
                      ? SizedBox(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) => ProductItemWidget(
                              ...
                              onLikePressed: () => event.likeOrUnlikeProduct(
