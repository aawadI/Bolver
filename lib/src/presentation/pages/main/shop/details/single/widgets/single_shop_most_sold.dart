...
class SingleShopMostSold extends StatelessWidget {
  final VoidCallback onSeeAllPressed;

  const SingleShopMostSold({Key? key, required this.onSeeAllPressed})
      : super(key: key);
        ...
        children: [
          ...
          Consumer(
            builder: (context, ref, child) {
              final state = ref.watch(singleShopMostSoldProvider);
              final event = ref.read(singleShopMostSoldProvider.notifier);
