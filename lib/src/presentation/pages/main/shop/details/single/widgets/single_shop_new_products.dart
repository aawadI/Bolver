...
class SingleShopNewProducts extends ConsumerWidget {
  final VoidCallback onSeeAllPressed;

  const SingleShopNewProducts({Key? key, required this.onSeeAllPressed})
      : super(key: key);

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final state = ref.watch(singleShopNewProductsProvider);
    final notifier = ref.read(singleShopNewProductsProvider.notifier);
              ...
              : state.products.isNotEmpty
                  ? SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        padding: REdgeInsets.symmetric(horizontal: 15),
                        itemBuilder: (context, index) => NewProductItemWidget(
                  ...
                  : Column(
                      ...
                      children: [
                        ...
                        14.verticalSpace,
                        Text(
                          '${AppHelpers.getTranslation(TrKeys.thereAreNoItemsInThe)} ${AppHelpers.getTranslation(TrKeys.newProducts).toLowerCase()}',
                          style: GoogleFonts.cairo(
                            fontSize: 14.sp,
