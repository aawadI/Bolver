...
class SingleShopViewed extends ConsumerWidget {
  final VoidCallback onSeeAllPressed;

  const SingleShopViewed({Key? key, required this.onSeeAllPressed})
      : super(key: key);

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final state = ref.watch(singleShopViewedProvider);
    final notifier = ref.read(singleShopViewedProvider.notifier);
