...
class ProfitableProductsBody extends ConsumerStatefulWidget {
  const ProfitableProductsBody({Key? key}) : super(key: key);

  @override
  ConsumerState<ProfitableProductsBody> createState() =>
      _ProfitableProductsBodyState();
}

class _ProfitableProductsBodyState
    extends ConsumerState<ProfitableProductsBody> {
