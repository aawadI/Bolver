...
class ProfitableNotifier extends StateNotifier<ProfitableState> {
  final ProductsRepository _productsRepository;
  int _page = 0;
  bool _hasMore = true;
  Timer? _timer;

  ProfitableNotifier(this._productsRepository) : super(const ProfitableState());
  ...
  Future<void> fetchMoreProducts() async {
    ...
    final response =
        await _productsRepository.getProfitableProducts(page: ++_page);
    response.when(
      success: (data) {
  ...
  Future<void> initialFetchProducts() async {
    _page = 0;
    _hasMore = true;
