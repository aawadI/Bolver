                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            '${AppHelpers.getTranslation(TrKeys.status)} ${AppHelpers.getTranslation(TrKeys.order)}: ${order.status}',
                            style: GoogleFonts.cairo(
                              fontWeight: FontWeight.w500,
                              fontSize: 13.sp,
                              letterSpacing: -14 * 0.01,
                          ...
                          Text(
                            '${AppHelpers.getTranslation(TrKeys.status)} ${AppHelpers.getTranslation(TrKeys.payment)}: ${AppHelpers.getTranslation(order.transaction?.status ?? "no_payment")}',
                            style: GoogleFonts.cairo(
                              fontWeight: FontWeight.w500,
                              fontSize: 13.sp,
                              letterSpacing: -14 * 0.01,
